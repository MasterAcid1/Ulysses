...
class Client {
    ...
    loadGUI() {
        ...
        <input onchange="localStorage.setItem('botAmount', this.value);" id="BotAmount" maxlength="3" class="access-control-context" placeholder="Bot Amount" value="57"></input>
		...
		<center><button id="botsalive" class="btn btn-success">Bots alive: 0/57</button></center>
        `);
        ...
        if (!localStorage.getItem('botAmount')) localStorage.setItem('botAmount', 57);
    ...
    startBots(amount) {
        ...
        amount > 57 ? amount = 57 : amount = amount;
		...
		$('#botsalive').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 13/57</button>`);
		setTimeout(function(){ $('#botsaliveone').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 27/57</button>`); }, 1000);
		setTimeout(function(){ $('#botsaliveone').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 35/57</button>`); }, 2500);
		setTimeout(function(){ $('#botsaliveone').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 42/57</button>`); }, 3500);
		setTimeout(function(){ $('#botsaliveone').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 56/57</button>`); }, 4500);
		setTimeout(function(){ $('#botsaliveone').replaceWith(`<button id='botsaliveone' class='btn btn-success'>Bots alive: 57/57</button>`); }, 5500);
    }
